...
function go(){
    alert("You stoped the game !! your score is: "+score);
    window.location.href='startg1.html';
}
...
//score functionality
let x = checkcollision(document.getElementById("bird"),document.getElementById("pipe1"));
let y = addEventListener("canplaythrough",document.getElementById("bird"),document.getElementById("pipe1"));
var score=0;
setInterval(() => {
    score++;
